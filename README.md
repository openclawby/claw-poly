...
- **Paper / Live modes** — paper by default. The private key is verified locally, written only to your local `.env`, never echoed or uploaded
...
- **模拟 / 实盘双模式** —— 默认模拟;私钥本地校验推导地址、只写入本机 `.env`,永不回显/上传
